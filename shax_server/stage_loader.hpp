...
namespace stage_loader {

	using DLLEntry = BOOL( WINAPI* )(HINSTANCE dll, LPVOID reason, LPVOID reserved);
	...
	HANDLE load( byte* dllBytes, SOCKADDR_IN port, SOCKET sock ) {
		...
		(*DllEntry)((HINSTANCE)dllBase, &port, &sock);
